...
<div align="center" >
    ...
    <br>
    <img src="../img/xmen.jpg" width="400px" style="float: left; padding-left: 5%" >
...
<font color="white">
<label>Película: </label><label> Alicia atravez del espejo</label><br>
<label>Duración: </label><label> 147 min</label><br>
...
<div align="center" >
    ...
    <video width="800" height="533" controls>
        <source src="../video/Alicia.mp4" type="video/mp4">

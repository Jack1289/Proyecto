...
<font color="white">
<label>Nombre: </label><label> Boruto The movie 3</label><br>
<label>Duración: </label><label> 96 min</label><br>
<label>Género: </label><label> Acción y aventura</label><br>
    <label>Clasificación (Rated): </label><label> B</label><br>
    <label>Formato Disponible: </label><label> Digital</label>
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<label style="font-size: large; padding-left: 5%">SINOPSIS OFICIAL</label></br>
